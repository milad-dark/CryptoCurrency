        ...
        public class AuthorizeAttributeFilterAttribute : IAsyncAuthorizationFilter
        {
            ...
            public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
            {
                try
                {
                    ...
                    {
                        new Claim(ClaimTypes.Name, decryptedToken[ClaimTypes.Name].ToString()),
                        new Claim(ClaimTypes.NameIdentifier, decryptedToken[ClaimTypes.NameIdentifier].ToString())
                    };
