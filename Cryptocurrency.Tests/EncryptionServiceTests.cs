...
namespace Cryptocurrency.Tests
{
    public class EncryptionServiceTests
    {
        ...
        {
            string key = "SecureKey123456789012345678901234567890";
            Dictionary<string, object> plainText = new Dictionary<string, object> {
                {"1","test1" },
                {"2","test2" },
                {"3","test3" },
            };

            string encryptedText = new JwtEncryptionService().GenerateEncryptedJwt(plainText, key);
